                        ...
                        <div className="col-lg-12 col-md-12 mt-5">
                            <div className="card shadow border-0">
                                <div className="report p-5 text-center">
                                    <h2 className="mb-3">Total: {Total.Amount > 0 ? <NumericFormat value={Total.Amount} displayType={'text'} thousandSeparator={true} prefix={'$ '} /> : 0}</h2>
                                        ...
                                        <table className="table text-center table-bordered">
                                            ...
                                            <tbody>
                                                {dataList.map((item, index) => (
                                                    <tr key={index}>
                                                        <td><NumericFormat value={item.Amount} displayType={'text'} thousandSeparator={true} prefix={'$ '} /></td>
                                                        <td>{item.Note}</td>
