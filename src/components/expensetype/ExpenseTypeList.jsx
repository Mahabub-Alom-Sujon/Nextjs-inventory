...
const ExpenseTypeList = () => {
    ...
    const { data, mutate } = useSWR(`/api/dashboard/expense_types/read-list?pageNo=${pageNo}&perPage=${perPage}&searchKey=${searchKey}`, Fetcher);
    ...
    const onDelete = async (id) => {
        ...
        if (Result.isConfirmed) {
            ...
            // }
            // let res=await fetch(`/api/dashboard/expense_types/delete?id=${id}`,options);
                                ...
                                <div className='container g-0'>
                                    <div className='row gx-2 align-items-center'>
                                        <div className='col-lg-4 col-md-12'>
                                            <h2 className='mb-0'>Expense Type List</h2>
                                        </div>
                                                ...
                                                <div className='table-responsive table-section'>
                                                    ...
                                                    <thead className="bg-white">
                                                            <tr>
                                                                ...
                                                                <td className="text-uppercase">Created</td>
                                                        ...
                                                        <tbody>
                                                            {data && data['data'].map((item, i) => (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td>
                                                                        <Link href={`/ExpenseTypeCreateUpdate?id=${item['id']}`}><AiOutlineEdit className='pen' /></Link>
