...
const ReturnList = () => {
    ...
    const { data, mutate } = useSWR(`/api/dashboard/returns/read-list?pageNo=${pageNo}&perPage=${perPage}&searchKey=${searchKey}`, Fetcher);
    ...
    const onDelete = async (id) => {
        ...
        if (Result.isConfirmed) {
            ...
            // }
            // let res=await fetch(`/api/dashboard/returns/delete?id=${id}`,options);
                                ...
                                <div className='container g-0'>
                                    <div className='row gx-2 align-items-center'>
                                        <div className='col-lg-4 col-md-12'>
                                            <h2 className='mb-0'>Return List</h2>
                                        </div>
                                                ...
                                                <div className='table-responsive table-section'>
                                                    ...
                                                    <thead className="bg-white">
                                                            <tr>
                                                                ...
                                                                <td className="text-uppercase">Customer</td>
                                                        ...
                                                        <tbody>
                                                            {data && data['data'].map((item, i) => (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td><p className="text-center text-xs mb-0">{item.customers["Name"]}</p></td>
                                                                    <td>
