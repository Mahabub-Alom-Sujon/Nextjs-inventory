...
const SupplierList = () => {
    ...
    const { data, mutate } = useSWR(`/api/dashboard/suppliers/read-list?pageNo=${pageNo}&perPage=${perPage}&searchKey=${searchKey}`, Fetcher);
    ...
    const onDelete = async (id) => {
        ...
        if (Result.isConfirmed) {
            ...
            // }
            // let res=await fetch(`/api/dashboard/suppliers/delete?id=${id}`,options);
                                                        ...
                                                        <tbody>
                                                            {data && data['data'].map((item, i) => (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td>
                                                                        <Link href={`/SupplierCreateUpdate?id=${item['id']}`}><AiOutlineEdit className='pen' /></Link>
