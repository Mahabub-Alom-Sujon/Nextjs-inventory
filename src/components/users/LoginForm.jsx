                    ...
                    <div className='col-lg-5 col-md-8 col-sm-10'>
                        <div className='from-box'>
                            <from className="card animated fadeIn p-5 shadow border-0">
                                ...
                                <div className="mt-4">
                                    <h6><span>Email ঃ</span>mahabub.sujon78@gmail.com</h6>
                                    <h6 className="mb-0"><span>Password ঃ</span>123456</h6>
                                </div>
                                <div className="my-3 d-flex">
                                    <Link href="/user/registration" className="nav-link">Sign Up |</Link>
