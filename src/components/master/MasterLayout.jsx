  ...
  return (
    <>
        ...
        <Container fluid>
          ...
          <div className="float-right h-auto d-flex align-items-center">
            <div className="user-dropdown">
              ...
              <img className="icon-nav-img icon-nav" src={storedPhoto || Data['photo']} alt="photo" />
              <div className="user-dropdown-content pb-3">
                <div className="mt-3 text-center">
                  <img className="icon-nav-img-lg" src={storedPhoto || Data['photo']} alt="photo" />
      ...
      <div ref={sideNavRef} className="side-nav-open border-radius-0 card">
        <Link href="/Dashboard" className="d-flex justify-content-center sticky-top bg-white">
