...
const SaleList = () => {
    ...
    const { data, mutate } = useSWR(`/api/dashboard/sales/read-list?pageNo=${pageNo}&perPage=${perPage}&searchKey=${searchKey}`, Fetcher);
    ...
    const onDelete = async (id) => {
        ...
        if (Result.isConfirmed) {
            ...
            // }
            // let res=await fetch(`/api/dashboard/sales/delete?id=${id}`,options);
                                ...
                                <div className='container g-0'>
                                    <div className='row gx-2 align-items-center'>
                                        <div className='col-lg-4'>
                                            <h2 className='mb-0'>Sale List</h2>
                                        </div>
