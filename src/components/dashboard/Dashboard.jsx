                ...
                <div className='row'>
                    <div className='col-md-3'>
                        <div className='card shadow border-0 text-center'>
                            <div className='card-body p-4'>
                                <h2>
                                    <NumericFormat value={expenses.totalAmount._sum.Amount} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                                </h2>
                                <h3>Total Expense</h3>
                            </div>
                        </div>
                    ...
                    <div className='col-md-3'>
                        <div className='card shadow border-0 text-center'>
                            <div className='card-body p-4'>
                                <h2>
                                    <NumericFormat value={sales.totalAmount._sum['GrandTotal']} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                                </h2>
                                <h3>Total Sale</h3>
                            </div>
                        </div>
                    ...
                    <div className='col-md-3'>
                        <div className='card shadow border-0 text-center'>
                            <div className='card-body p-4'>
                                <h2>
                                    <NumericFormat value={purchase.totalAmount._sum['GrandTotal']} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                                </h2>
                    ...
                    <div className='col-md-3'>
                        <div className='card shadow border-0 text-center'>
                            <div className='card-body p-4'>
                                <h2>
                                    <NumericFormat value={returns.totalAmount._sum["GrandTotal"]} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                                </h2>
                                <h3>Total Return</h3>
                            </div>
                        </div>
                    ...
                    {[
                        ...
                        <div className='col-md-6 col-lg-3 pb-3' key={index}>
                            <div className='card shadow border-0 text-center'>
                                <div className='card-body p-4'>
                                    <h2>
                                        <NumericFormat value={item.value || 0} displayType="text" thousandSeparator={true} prefix="$" />
                                    </h2>
                                    <h3>{item.title}</h3>
                                </div>
                            </div>
